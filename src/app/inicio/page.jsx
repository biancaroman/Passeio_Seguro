  ...
  return (
    <main>
      <section>
        <div className="bg-cover bg-center h-[550px] relative  md:top-0 flex justify-center items-center">
          ...
          <div className="w-90 md:w-full p-10 text-black absolute top-12 left-0">
            ...
            <button className="bg-blue-500 text-white rounded-lg px-28 py-4 md:px-13 md:py-3 font-bold mx-5">
      ...
      <section>
        <div>
          <div className="p-20">
            <h1 className="text-2xl font-bold md:text-4xl mb-4">Com a Passeio Seguro, você <br />terá diversos Benefícios</h1>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-1/4 bg-white text-black p-4 mx-4 my-8 text-center rounded-lg shadow-lg">
